...
#define USE_LINES 
	...
	__attribute__ ((always_inline)) inline static uint32_t bits(Lines & b) {
		...
		fuckery.b0 = (b.raw[0] >> 30);
		fuckery.b1 = (b.raw[0] >> 22);
		fuckery.b2 = (b.raw[0] >> 14);
		fuckery.b3 = (b.raw[0] >> 6);
		fuckery.b4 = (b.raw[1] >> 30);
		fuckery.b5 = (b.raw[1] >> 22);
		fuckery.b6 = (b.raw[1] >> 14);
		fuckery.b7 = (b.raw[1] >> 6);
		fuckery.c0 = (b.raw[0] >> 29);
		fuckery.c1 = (b.raw[0] >> 21);
		fuckery.c2 = (b.raw[0] >> 13);
		fuckery.c3 = (b.raw[0] >> 5);
		fuckery.c4 = (b.raw[1] >> 20);
		fuckery.c5 = (b.raw[1] >> 21);
		fuckery.c6 = (b.raw[1] >> 13);
		fuckery.c7 = (b.raw[1] >> 5);
		// fuckery.d0 = (b.raw[0] >> 28);
		// fuckery.d1 = (b.raw[0] >> 19);
		// fuckery.d2 = (b.raw[0] >> 12);
		// fuckery.d3 = (b.raw[0] >> 4);
		// fuckery.d4 = (b.raw[1] >> 28);
		// fuckery.d5 = (b.raw[1] >> 19);
		// fuckery.d6 = (b.raw[1] >> 12);
		// fuckery.d7 = (b.raw[1] >> 4);
		return fuckery.word;
	}
