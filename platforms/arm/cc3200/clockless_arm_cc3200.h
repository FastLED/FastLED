#ifndef __INC_CLOCKLESS_ARM_CC3200_H
#define __INC_CLOCKLESS_ARM_CC3200_H

FASTLED_NAMESPACE_BEGIN

// Definition for a single channel clockless controller for the CC3200 microcontroller
