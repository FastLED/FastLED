...
#define __FASTSPI_ARM_NRF52_H
    ...
    //#if (FASTLED_NRF52_SPIM == NRF_SPIM3)
    //    #error "SPIM3 on nRF52840 requires additional work to support due to extended capabilities"
    //    #if NRFX_CHECK(NRFX_SPIM3_NRF52840_ANOMALY_198_WORKAROUND_ENABLED)
    //        #error "SPIM3 has an anomaly that is not worked around in FastLED at this time"
    //    #endif
    //#endif
    ...
    public:
        ...
        void init() {
            ...
            nrf_spim_pins_set(
                FASTLED_NRF52_SPIM,
                FastPin<_CLOCK_PIN>::nrfx_pin(),
                FastPin<_DATA_PIN>::nrfx_pin(),
