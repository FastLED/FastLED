#!/usr/bin/env python3
"""
Caching wrapper for isort that only runs if Python files have changed.
This significantly speeds up repeated isort runs during development.
"""
...
def run_isort(args: List[str]) -> int:
    """Run isort with the given arguments."""
    cmd = ["uv", "run", "isort"] + args
