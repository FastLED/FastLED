...
pub fn supported_checker_names() -> &'static [&'static str] {
    &[
        ...
        "cpp_hpp_header_pair",
        "cpp_include",
        "container_element_address",
        "container_non_contiguous_ptr",
        "ctype_global",
        "em_asm_clang_format",
        "enum_class",
        "esp_rom_printf",
...
pub fn create_checkers(
    ...
    let mut checkers: Vec<(&'static str, Box<dyn FileContentChecker>)> = vec![
        ...
        (
            "container_element_address",
            Box::new(ContainerElementAddressChecker),
        ),
        (
            "container_non_contiguous_ptr",
            Box::new(ContainerNonContiguousPtrChecker),
        ),
        ...
        ("r1_cleanup", Box::new(R1CleanupChecker)),
        ...
        ("prefer_constexpr", Box::new(PreferConstexprChecker)),
