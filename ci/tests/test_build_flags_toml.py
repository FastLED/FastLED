...
"""
        ...
        self.assertEqual(flags.tools.compiler_command, ["uv", "run", "python", "-m", "ziglang", "c++"])
...
"""
    ...
    def test_serialize_build_flags_with_tools(self) -> None:
        ...
        # Check that tools section is present with modern command-based fields
        self.assertIn("[tools]", toml_output)
        self.assertIn("compiler_command = ['arm-none-eabi-g++']", toml_output)
        self.assertIn("archiver_command = ['arm-none-eabi-ar']", toml_output)
    ...
    def test_round_trip_toml_parsing(self) -> None:
        ...
        self.assertEqual(parsed_flags.tools.compiler_command, original_flags.tools.compiler_command)
        self.assertEqual(parsed_flags.tools.archiver_command, original_flags.tools.archiver_command)
...
"""
        ...
        self.assertEqual(flags_parse.tools.compiler_command, flags_alias.tools.compiler_command)
