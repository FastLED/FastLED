...
class TestSymbolAnalysis(unittest.TestCase):
    ...
    def test_analyze_symbols_basic(self) -> None:
        ...
        symbols = analyze_symbols(
            str(ELF_FILE),
            str(self.tools.nm_path),
            str(self.tools.cpp_filt_path)
        )
    ...
    def test_analyze_symbols_from_build_info(self) -> None:
        ...
        self.assertTrue(all(size > 0 for size in sizes), "All symbols should have positive sizes")
    ...
    def test_generate_report_basic(self) -> None:
        ...
        test_dependencies = {
            'test_module.o': ['test_function_1', 'test_data']
        }
    ...
    def test_full_symbol_analysis_workflow(self) -> None:
        ...
        print(f"  Total size: {report['total_size']} bytes ({report['total_size']/1024:.1f} KB)")
        print(f"  Largest symbol: {report['largest_symbols'][0]['demangled_name']} ({report['largest_symbols'][0]['size']} bytes)")
