        ...
        try:
            ...
            if not examples_selector:
                ...
                try:
                    ...
                    print("FestivalStick text not found, taking screenshot of current page...")
            ...
            for element_selector in interface_elements:
                try:
                    canvas_element = await page.wait_for_selector(element_selector, timeout=2000)
                    if canvas_element:
            ...
            try:
                ...
                if file_input:
                    ...
                    festival_stick_path = PROJECT_ROOT / "examples" / "FestivalStick" / "FestivalStick.ino"
            ...
            if canvas_found and canvas is not None:
                try:
                    canvas_screenshot_path = SCREENSHOTS_DIR / f"festival_stick_canvas_{timestamp}.png"
            ...
            error_screenshot_path = SCREENSHOTS_DIR / f"error_{datetime.now().strftime('%Y%m%d_%H%M%S')}.png"
            try:
