...
- **When the check applies:** any time an agent is about to write "requires bench validation, deferred" for a driver / peripheral / autoresearch task on any platform the AutoResearch harness supports.
