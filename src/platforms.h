...
#include "platforms/arm/teensy/teensy31_32/fastled_arm_k20.h"  // ok platform headers
#elif defined(__MK66FX1M0__) || defined(__MK64FX512__)
// Teensy 3.5/3.6 (MK64/MK66 Cortex-M4)
#include "platforms/arm/teensy/teensy36/fastled_arm_k66.h"  // ok platform headers
#elif defined(__MKL26Z64__)
// Teensy LC (MKL26Z64 Cortex-M0+)
#include "platforms/arm/teensy/teensy_lc/fastled_arm_kl26.h"  // ok platform headers
#elif defined(__IMXRT1062__)
// Teensy 4.0/4.1 (IMXRT1062 Cortex-M7)
#include "platforms/arm/teensy/teensy4_common/fastled_arm_mxrt1062.h"  // ok platform headers
#elif defined(__SAM3X8E__)
// Include sam/due headers
#include "platforms/arm/sam/fastled_arm_sam.h"  // ok platform headers
#elif defined(STM32F10X_MD) || defined(__STM32F1__) || defined(STM32F1) || defined(STM32F1xx) || defined(STM32F2XX) || defined(STM32F4) || defined(STM32U5) || defined(STM32U5xx) || defined(STM32U585xx) || defined(STM32U585XX) || defined(ARDUINO_UNO_Q) || defined(CONFIG_BOARD_ARDUINO_UNO_Q)
...
#include "platforms/arm/d51/fastled_arm_d51.h"  // ok platform headers
#elif defined(PICO_RP2350) || defined(ARDUINO_ARCH_RP2350)
// RP2350 (Raspberry Pi Pico 2)
#include "platforms/arm/rp/rp2350/fastled_arm_rp2350.h"  // ok platform headers
#elif defined(ARDUINO_ARCH_RP2040) || defined(PICO_RP2040)
// RP2040 (Raspberry Pi Pico etc)
#include "platforms/arm/rp/rp2040/fastled_arm_rp2040.h"  // ok platform headers
...
#include "platforms/arm/renesas/fastled_arm_renesas.h"  // ok platform headers
#elif defined(ARDUINO_GIGA) || defined(ARDUINO_GIGA_M7)
#include "platforms/arm/giga/fastled_arm_giga.h"  // ok platform headers
...
#include "platforms/arm/mgm240/fastled_arm_mgm240.h"  // ok platform headers
#elif defined(__x86_64__) || defined(FASTLED_STUB_IMPL)

// stub platform for testing (on cpu)
#include "platforms/stub/fastled_stub.h"  // ok platform headers
#else
// AVR platforms
#include "platforms/avr/fastled_avr.h"  // ok platform headers
#endif
