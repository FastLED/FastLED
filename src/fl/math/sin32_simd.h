...
/// @file sin32_simd.h
/// @brief Four-lane SIMD batch of fl::sincos32.
///
/// Split out of sin32.h so that the scalar sin32/cos32 LUT (reached from
/// CRGB via ease.h and the fixed-point types) no longer drags fl/math/simd.h
/// and the platform intrinsics into every translation unit. Include this
/// header only where sincos32_simd() is actually used.
