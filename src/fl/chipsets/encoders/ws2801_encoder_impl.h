...
/// version is in ws2801_encoder.h and is used throughout the codebase.
///
...
/// then use the encoders in ws2801_encoder.h.
///
...
///
/// @deprecated Use the input iterator version in ws2801_encoder.h instead:
...
void encodeWS2801(InputIterator first, InputIterator last, OutputIterator out) {
    // Forward to the modern implementation in ws2801_encoder.h
