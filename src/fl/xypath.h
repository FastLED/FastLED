...
class XYPath : public Referent {
  public:
    ...
    static XYPathPtr
    NewLinePath(const fl::shared_ptr<LinePathParams> &params = fl::make_intrusive<LinePathParams>());
    ...
    static XYPathPtr NewCatmullRomPath(
        ...
        const fl::shared_ptr<CatmullRomParams> &params = fl::make_intrusive<CatmullRomParams>());
    ...
    NewRosePath(u16 width = 0, u16 height = 0,
                const fl::shared_ptr<RosePathParams> &params = fl::make_intrusive<RosePathParams>());

    static XYPathPtr NewPhyllotaxisPath(
        u16 width = 0, u16 height = 0,
        const fl::shared_ptr<PhyllotaxisParams> &args = fl::make_intrusive<PhyllotaxisParams>());

    static XYPathPtr NewGielisCurvePath(
        u16 width = 0, u16 height = 0,
        const fl::shared_ptr<GielisCurveParams> &params = fl::make_intrusive<GielisCurveParams>());
    // END pre-baked paths.
