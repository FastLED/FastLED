...
// Include implementation details for inline functions
// NOTE: This is also included in src/fl/_build.cpp for the library build,
// but inline functions with internal linkage won't cause issues
#include "fl/fx/2d/animartrix2_detail/_build.cpp.hpp"  // ok include cpp.hpp
