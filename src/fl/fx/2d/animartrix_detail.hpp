  ...
  public:
    ...
    */
    ...
    void report_performance() {
        ...
        ANIMARTRIX_PRINT(fl::round(total));
        ANIMARTRIX_PRINT(" µs per frame  waiting: ");
        ANIMARTRIX_PRINT(fl::round((calc * 100) / total));
        ANIMARTRIX_PRINT("%  rendering: ");
        ANIMARTRIX_PRINT(fl::round((push * 100) / total));
        ANIMARTRIX_PRINT("%  (");
        ANIMARTRIX_PRINT(fl::round(calc));
        ANIMARTRIX_PRINT(" + ");
        ANIMARTRIX_PRINT(fl::round(push));
