...
public:
    ...
    RedBlackTree& operator=(const RedBlackTree& other) FL_NO_EXCEPT {
        if (this != &other) {
            clear();
            mSize = other.mSize;
            mComp = other.mComp;
    ...
    // Move constructor
    RedBlackTree(RedBlackTree&& other) FL_NO_EXCEPT
    ...
    RedBlackTree& operator=(RedBlackTree&& other) FL_NO_EXCEPT {
        if (this != &other) {
            clear();
            mRoot = other.mRoot;
            mSize = other.mSize;
...
public:
    ...
    // Move constructor
    MapRedBlackTree(MapRedBlackTree&& other) FL_NO_EXCEPT = default;

    // Move assignment operator
    MapRedBlackTree& operator=(MapRedBlackTree&& other) FL_NO_EXCEPT = default;

    // Initializer list assignment operator
    // Replaces the contents of the map with the contents of the initializer list
    MapRedBlackTree& operator=(fl::initializer_list<value_type> ilist) FL_NO_EXCEPT {
        clear();
...
public:
    ...
    SetRedBlackTree& operator=(const SetRedBlackTree& other) FL_NO_EXCEPT = default;
    SetRedBlackTree& operator=(SetRedBlackTree&& other) FL_NO_EXCEPT = default;
