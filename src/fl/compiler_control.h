...
// WARNING SPECIFIC MACROS THAT MAY NOT BE UNIVERSAL.
  ...
  #define FL_DISABLE_WARNING_SHIFT_COUNT_OVERFLOW FL_DISABLE_WARNING(shift-count-overflow)
  #define FL_DISABLE_WARNING_OVERFLOW FL_DISABLE_WARNING(overflow)
  #define FL_DISABLE_WARNING_SIGN_COMPARE FL_DISABLE_WARNING(sign-compare)
#elif defined(__GNUC__) && (__GNUC__*100 + __GNUC_MINOR__) >= 406
  ...
  #define FL_DISABLE_WARNING_SIGN_CONVERSION
  #define FL_DISABLE_WARNING_SHORTEN_64_TO_32
  #define FL_DISABLE_WARNING_SHIFT_COUNT_OVERFLOW
  #define FL_DISABLE_WARNING_OVERFLOW
  #define FL_DISABLE_WARNING_SIGN_COMPARE
#endif
