...
UIAudio::UIAudio(const fl::string& name) FL_NO_EXCEPT : mImpl(name) {}
UIAudio::UIAudio(const fl::string& name, const fl::url& url) FL_NO_EXCEPT : mImpl(name, url) {}
...
UIAudio::UIAudio(const fl::string& name, const fl::asset_ref& asset) FL_NO_EXCEPT
    : mImpl(name, fl::resolve_asset(asset)) {}

UIAudio::UIAudio(const fl::string& name, const fl::audio::Config& config) FL_NO_EXCEPT : mImpl(name, config), mConfig(config) {}
UIAudio::~UIAudio() FL_NO_EXCEPT {}

fl::shared_ptr<audio::Processor> UIAudio::processor() FL_NO_EXCEPT {
    if (!mProcessor) {
