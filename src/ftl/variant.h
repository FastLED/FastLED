...
#include "ftl/type_traits.h" // for fl::enable_if, fl::is_same, etc.
#include "ftl/bit_cast.h"    // for safe type-punning
#include "ftl/new.h"          // for placement new operator (must be before namespace fl)
