...
fl::HSV16 noiseCylinderHSV16(float angle, float height, uint32_t time, float radius) {
...
fl::hsv8 noiseCylinderHSV8(float angle, float height, uint32_t time, float radius) {
  fl::HSV16 hsv16 = noiseCylinderHSV16(angle, height, time, radius);
