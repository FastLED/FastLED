...
private:
	// Forward declarations for tiered-wait setter (#2818, full impl in
	// fl/channels/detail/wait_yield.{h,cpp.hpp}). Declared here so we don't
	// drag the whole channel-detail include graph into FastLED.h.
...
public:
	...
	/// `FASTLED_WAIT_SPIN_BUDGET_US` (250 µs).
	///
