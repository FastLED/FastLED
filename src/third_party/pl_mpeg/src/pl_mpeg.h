...
void plm_decode(plm_t *self, double seconds) FL_NO_EXCEPT;
...
plm_packet_t *plm_demux_seek(plm_demux_t *self, double time, int type, int force_intra) FL_NO_EXCEPT;
...
void plm_frame_to_rgb(plm_frame_t *frame, uint8_t *dest, int stride) FL_NO_EXCEPT;
void plm_frame_to_bgr(plm_frame_t *frame, uint8_t *dest, int stride) FL_NO_EXCEPT;
void plm_frame_to_rgba(plm_frame_t *frame, uint8_t *dest, int stride) FL_NO_EXCEPT;
void plm_frame_to_bgra(plm_frame_t *frame, uint8_t *dest, int stride) FL_NO_EXCEPT;
void plm_frame_to_argb(plm_frame_t *frame, uint8_t *dest, int stride) FL_NO_EXCEPT;
void plm_frame_to_abgr(plm_frame_t *frame, uint8_t *dest, int stride) FL_NO_EXCEPT;
