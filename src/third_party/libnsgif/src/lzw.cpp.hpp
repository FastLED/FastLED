...
lzw_result lzw_context_create(struct lzw_ctx **ctx) FL_NO_EXCEPT
{
...
/* Exported function, documented in lzw.h */
void lzw_context_destroy(struct lzw_ctx *ctx) FL_NO_EXCEPT
{
	fl::Free(ctx);
}
 ...
 */
static lzw_result lzw__block_advance(struct lzw_read_ctx * ctx) FL_NO_EXCEPT
{
	fl::size block_size;
...
lzw_result lzw_decode_init(
		...
		fl::size input_pos) FL_NO_EXCEPT
{
...
static inline lzw_result lzw__decode(
		...
		void     * output_data,
		fl::u32          output_length,
		fl::u32 * output_written) FL_NO_EXCEPT
{
	lzw_result res;
	fl::u16 code = 0;
