...
void stb_vorbis_close(stb_vorbis *f) FL_NO_EXCEPT;
...
stb_vorbis *stb_vorbis_open_pushdata(
         ...
         int32_t *error,
         const stb_vorbis_alloc *alloc_buffer) FL_NO_EXCEPT;
...
int32_t stb_vorbis_decode_memory(const unsigned char *mem, int32_t len, int32_t *channels, int32_t *sample_rate, int16_t **output) FL_NO_EXCEPT;
#endif
...
stb_vorbis * stb_vorbis_open_memory(const unsigned char *data, int32_t len,
                                  int32_t *error, const stb_vorbis_alloc *alloc_buffer) FL_NO_EXCEPT;
...
int32_t stb_vorbis_get_frame_short_interleaved(stb_vorbis *f, int32_t num_c, int16_t *buffer, int32_t num_shorts) FL_NO_EXCEPT;
int32_t stb_vorbis_get_frame_short            (stb_vorbis *f, int32_t num_c, int16_t **buffer, int32_t num_samples) FL_NO_EXCEPT;
#endif
...
int32_t stb_vorbis_get_samples_float(stb_vorbis *f, int32_t channels, float **buffer, int32_t num_samples) FL_NO_EXCEPT;
...
#ifndef FL_STB_VORBIS_NO_INTEGER_CONVERSION
int32_t stb_vorbis_get_samples_short_interleaved(stb_vorbis *f, int32_t channels, int16_t *buffer, int32_t num_shorts) FL_NO_EXCEPT;
int32_t stb_vorbis_get_samples_short(stb_vorbis *f, int32_t channels, int16_t **buffer, int32_t num_samples) FL_NO_EXCEPT;
#endif
// gets num_samples samples, not necessarily on a frame boundary--this requires
