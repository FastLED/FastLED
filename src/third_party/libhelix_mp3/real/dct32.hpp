...
#define COS4_0  ((int32_t)0x5a82799a)	/* Q31 */
...
void FDCT32(int32_t *buf, int32_t *dest, int offset, int oddBlock, int gb)
{
    int32_t i, s, tmp, es;
	...
	for (i = 4; i > 0; i--) {
		...
		b0 = a0 + a7;	    b7 = MULSHIFT32(*cptr++, a0 - a7) * 2;
		b3 = a3 + a4;	    b4 = MULSHIFT32(*cptr++, a3 - a4) * 8;
		a0 = b0 + b3;	    a3 = MULSHIFT32(*cptr,   b0 - b3) * 2;
		a4 = b4 + b7;		a7 = MULSHIFT32(*cptr++, b7 - b4) * 2;

		a1 = buf[1];	    a6 = buf[6];	    a2 = buf[2];	    a5 = buf[5];
		b1 = a1 + a6;	    b6 = MULSHIFT32(*cptr++, a1 - a6) * 2;
		b2 = a2 + a5;	    b5 = MULSHIFT32(*cptr++, a2 - a5) * 2;
		a1 = b1 + b2;		a2 = MULSHIFT32(*cptr,   b1 - b2) * 4;
		a5 = b5 + b6;	    a6 = MULSHIFT32(*cptr++, b6 - b5) * 4;

		b0 = a0 + a1;	    b1 = (int32_t)MULSHIFT32(COS4_0, a0 - a1) * 2;
		b2 = a2 + a3;	    b3 = (int32_t)MULSHIFT32(COS4_0, a3 - a2) * 2;
		buf[0] = b0;	    buf[1] = b1;
		buf[2] = b2 + b3;	buf[3] = b3;

		b4 = a4 + a5;	    b5 = (int32_t)MULSHIFT32(COS4_0, a4 - a5) * 2;
		b6 = a6 + a7;	    b7 = (int32_t)MULSHIFT32(COS4_0, a7 - a6) * 2;
		b6 += b7;
