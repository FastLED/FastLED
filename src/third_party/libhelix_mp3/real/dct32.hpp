...
void FDCT32(int32_t *buf, int32_t *dest, int32_t offset, int32_t oddBlock, int32_t gb)
{
	...
	for (i = 4; i > 0; i--) {
		...
		b0 = a0 + a1;	    b1 = (int32_t)MULSHIFT32(COS4_0, a0 - a1) * 2L;
		b2 = a2 + a3;	    b3 = (int32_t)MULSHIFT32(COS4_0, a3 - a2) * 2L;
		buf[0] = b0;	    buf[1] = b1;
		buf[2] = b2 + b3;	buf[3] = b3;

		b4 = a4 + a5;	    b5 = (int32_t)MULSHIFT32(COS4_0, a4 - a5) * 2L;
		b6 = a6 + a7;	    b7 = (int32_t)MULSHIFT32(COS4_0, a7 - a6) * 2L;
		b6 += b7;
