...
esp_err_t rmt_new_led_strip_encoder_with_timings(const led_strip_encoder_config_t *config, rmt_encoder_handle_t *ret_encoder) {
    ...
    bytes_encoder_config.bit0.duration0 = (float)config->timings.t0h * config->resolution / 1000000000;  // Convert ns to ticks
    bytes_encoder_config.bit0.level1 = 0;
    bytes_encoder_config.bit0.duration1 = (float)config->timings.t0l * config->resolution / 1000000000;
    bytes_encoder_config.bit1.level0 = 1;
    bytes_encoder_config.bit1.duration0 = (float)config->timings.t1h * config->resolution / 1000000000;
    bytes_encoder_config.bit1.level1 = 0;
    bytes_encoder_config.bit1.duration1 = (float)config->timings.t1l * config->resolution / 1000000000;
