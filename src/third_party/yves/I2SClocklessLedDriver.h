...
#error "This file should only be included from platforms/esp/32/yves_i2s.cpp"
#endif
...
#include "third_party/yves/I2SClocklessVirtualLedDriver/I2SClocklessVirtualLedDriver.h"
#else
