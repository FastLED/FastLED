...
public:
    ...
    uint8_t getLaneCount() const override { return 4; }
    ...
    static const fl::vector<fl::shared_ptr<SpiHw4>>& getAll();
    ...
    static void registerInstance(fl::shared_ptr<SpiHw4> instance);

    /// Remove a registered instance
    /// @param instance The shared pointer to remove from the registry
    /// @returns true if removed, false if not found
    static bool removeInstance(const fl::shared_ptr<SpiHw4>& instance);
