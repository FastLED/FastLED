...
public:
 ...
 FL_NOEXCEPT : bus_num(0)
    ...
    u8 getLaneCount() const FL_NOEXCEPT override { return 1; }
    ...
    static const fl::vector<fl::shared_ptr<SpiHw1>>& getAll() FL_NOEXCEPT;
    ...
    static void registerInstance(fl::shared_ptr<SpiHw1> instance) FL_NOEXCEPT;

    /// Remove a registered instance
    /// @param instance The shared pointer to remove from the registry
    /// @returns true if removed, false if not found
    static bool removeInstance(const fl::shared_ptr<SpiHw1>& instance) FL_NOEXCEPT;
