...
public:
    ...
    struct Config {
        ...
        i8 data8_pin;          ///< D8 GPIO pin
        i8 data9_pin;          ///< D9 GPIO pin
        i8 data10_pin;         ///< D10 GPIO pin
        i8 data11_pin;         ///< D11 GPIO pin
        i8 data12_pin;         ///< D12 GPIO pin
        i8 data13_pin;         ///< D13 GPIO pin
        i8 data14_pin;         ///< D14 GPIO pin
        i8 data15_pin;         ///< D15 GPIO pin
 ...
 FL_NO_EXCEPT : bus_num(0)
    ...
    u8 getLaneCount() const FL_NO_EXCEPT override { return 16; }
    ...
    static const fl::vector<fl::shared_ptr<SpiHw16>>& getAll() FL_NO_EXCEPT;
    ...
    static void registerInstance(fl::shared_ptr<SpiHw16> instance) FL_NO_EXCEPT;

    /// Remove a registered instance
    /// @param instance The shared pointer to remove from the registry
    /// @returns true if removed, false if not found
    static bool removeInstance(const fl::shared_ptr<SpiHw16>& instance) FL_NO_EXCEPT;
