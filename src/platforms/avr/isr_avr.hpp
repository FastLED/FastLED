/*
  FastLED — AVR ISR Implementation
  ---------------------------------
  AVR-specific implementation of the cross-platform ISR API.
...
// =============================================================================
// AVR ISR Implementation (fl::isr::platform namespace)
// =============================================================================
