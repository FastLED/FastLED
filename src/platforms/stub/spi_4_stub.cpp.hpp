...
bool SpiHw4Stub::begin(const SpiHw4::Config& config) FL_NO_EXCEPT {
    if (mInitialized) {
...
void SpiHw4Stub::end() FL_NO_EXCEPT {
    mInitialized = false;
    mBusy = false;
    mLastBuffer.clear();
...
DMABuffer SpiHw4Stub::acquireDMABuffer(size_t bytes_per_lane) FL_NO_EXCEPT {
    if (!mInitialized) {
...
bool SpiHw4Stub::transmit(TransmitMode mode) FL_NO_EXCEPT {
...
bool SpiHw4Stub::waitComplete(u32 timeout_ms) FL_NO_EXCEPT {
...
bool SpiHw4Stub::isBusy() const FL_NO_EXCEPT {
    return mBusy;
}

bool SpiHw4Stub::isInitialized() const FL_NO_EXCEPT {
    return mInitialized;
}

int SpiHw4Stub::getBusId() const FL_NO_EXCEPT {
    return mBusId;
}

const char* SpiHw4Stub::getName() const FL_NO_EXCEPT {
    return mName;
}

const fl::vector<u8>& SpiHw4Stub::getLastTransmission() const FL_NO_EXCEPT {
    return mLastBuffer;
}

u32 SpiHw4Stub::getTransmissionCount() const FL_NO_EXCEPT {
    return mTransmitCount;
}

u32 SpiHw4Stub::getClockSpeed() const FL_NO_EXCEPT {
    return mClockSpeed;
}

bool SpiHw4Stub::isTransmissionActive() const FL_NO_EXCEPT {
    return mBusy;
}

void SpiHw4Stub::reset() FL_NO_EXCEPT {
    mLastBuffer.clear();
    mTransmitCount = 0;
    mBusy = false;
}

fl::vector<fl::vector<u8>> SpiHw4Stub::extractLanes(u8 num_lanes, size_t bytes_per_lane) const FL_NO_EXCEPT {
...
fl::shared_ptr<SpiHw4Stub>& getController2_Spi4() FL_NO_EXCEPT {
    static fl::shared_ptr<SpiHw4Stub> instance = fl::make_shared<SpiHw4Stub>(2, "MockQuad2");
    return instance;
}

fl::shared_ptr<SpiHw4Stub>& getController3_Spi4() FL_NO_EXCEPT {
