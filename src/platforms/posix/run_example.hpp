...
/// Linux/POSIX implementation of example runner
///
/// This file provides the main() function for loading and executing FastLED
/// example shared libraries on Linux using dlopen/dlsym.
///
/// Usage: runner <example_so_path> [args...]
/// Or:    <example_name> (auto-loads <example_name>.so from same directory)
