...
private:
    ...
    int convertCommFormatToMode(audio::I2SCommFormat format) FL_NO_EXCEPT {
...
fl::shared_ptr<audio::IInput> arduino_create_audio_input(const audio::Config& config, fl::string* error_message = nullptr) FL_NO_EXCEPT {
