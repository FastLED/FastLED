...
// For some reason including the declaration does not work, you must include the
// *.hpp file??!?!?!
...
// Posts a message from JavaScript to C++. This is as raw as you can get, with
// no reciever control, which has to be handled by the user. It's recommended
// that that you send all strings as encoded json strings and then have your
