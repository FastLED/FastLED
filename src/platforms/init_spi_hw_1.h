...
/// @brief Platform dispatch header for SpiHw1 initialization
///
/// This dispatch header routes to platform-specific SpiHw1 initialization.
...
// ok no namespace fl
    ...
    #include "platforms/stub/init_spi_hw_1.h"
#else
