/// @file lcd_driver_p4.h
/// @brief ESP32-P4 RGB LCD parallel LED driver with 4-pixel encoding
///
/// This driver uses the ESP32-P4 RGB LCD peripheral to drive up to 16
...
/// @brief Configuration structure for P4 RGB LCD driver
struct LcdP4DriverConfig {
...
///
/// This driver uses the ESP32-P4's RGB LCD peripheral with 4-pixel encoding
...
public:
    ...
    bool begin(const LcdP4DriverConfig& config, int leds_per_strip);
