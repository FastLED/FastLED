// parallel_spi_blocking_quad.hpp — 4-way Quad-SPI Blocking driver (inline bit-banging)
#pragma once
...
/**
 * QuadSPI_Blocking_ESP32 - 4-way (quad-pin) blocking soft-SPI driver
 *
...
public:
    ...
    QuadSPI_Blocking_ESP32() = default;
    ~QuadSPI_Blocking_ESP32() = default;
