// parallel_spi_blocking_single.hpp — 1-way Single-SPI Blocking driver (inline bit-banging)
#pragma once
...
/**
 * SingleSPI_Blocking_ESP32 - 1-way (single-pin) blocking soft-SPI driver
 *
 ...
 * - Better timing precision (inline execution)
 */
class SingleSPI_Blocking_ESP32 {
public:
    ...
    SingleSPI_Blocking_ESP32() = default;
    ~SingleSPI_Blocking_ESP32() = default;
