...
private:
    ...
    static void task_entry(void* param) FL_NO_EXCEPT;
...
void TaskCoroutineESP32::task_entry(void* param) FL_NO_EXCEPT {
...
void TaskCoroutineESP32::stop() FL_NO_EXCEPT {
    if (!mTask) return;
...
bool TaskCoroutineESP32::isRunning() const FL_NO_EXCEPT {
