...
template <int HI_OFFSET, int LO_OFFSET, int T1, int T2, int T3,
          EOrder RGB_ORDER, int WAIT_TIME>
int showLedData(volatile uint32_t *_port, uint32_t _bitmask,
                const uint8_t *_leds, uint32_t num_leds,
    ...
    asm __volatile__(
        ...
        // Do the qadd8 for dithering -- there's two versions of this.  The m0
        // version takes advantage of the 3 cycle branch to do two things after
        // the branch, while keeping timing constant.  The m0+, however,
        // branches in 2 cycles, so we have to work around that a bit more. This
        // is one of the few times where the m0 will actually be _more_
        // efficient than the m0+
        "  .macro dither5 bn,d;"
        "  .syntax unified;"
        "    .if fl_is_m0p == 0;"
        ...
        // adjust the dithering value for the next time around (load e from
        // memory to do the math)
...
#define ADJDITHER7(X)                                                          \
    "  adjdither7 %[base],%[d],%[led" #X "],%[e" #X "],%[scratch];"
...
#define NOTHING ""
    ...
    asm __volatile__(
        // pre-load byte 0
        LOADLEDS3(0) LOADDITHER7(0) DITHER5 SCALE4(0) ADJDITHER7(0)
            SWAPBBN1 M0_ASM_ARGS);

    do {
        asm __volatile__(
            // Write out byte 0, prepping byte 1
            HI2 _D1 QLO4 NOTHING _D2(0) LO2 _D3(0) HI2 _D1 QLO4 LOADLEDS3(1)
                _D2(3) LO2 _D3(0) HI2 _D1 QLO4 LOADDITHER7(1) _D2(7) LO2 _D3(0)
            ...
            HI2 _D1 QLO4 NOTHING _D2(0) LO2 _D3(0) HI2 _D1 QLO4 LOADLEDS3(2)
                _D2(3) LO2 _D3(0) HI2 _D1 QLO4 LOADDITHER7(2) _D2(7) LO2 _D3(0)
                    HI2 _D1 QLO4 DITHER5 _D2(5) LO2 _D3(0)
            ...
            HI2 _D1 QLO4 INCLEDS3 _D2(3) LO2 _D3(0) HI2 _D1 QLO4 LOADLEDS3(0)
                _D2(3) LO2 _D3(0) HI2 _D1 QLO4 LOADDITHER7(0) _D2(7) LO2 _D3(0)
                    HI2 _D1 QLO4 DITHER5 _D2(5) LO2 _D3(0)
    ...
    do {
        asm __volatile__(
            ...
            // Write out byte 2, prepping byte 0
            HI2 _D1 QLO4 NOTHING _D2(0) LO2 _D3(0) HI2 _D1 QLO4 LOADLEDS3(0)
                _D2(3) LO2 _D3(0) HI2 _D1 QLO4 LOADDITHER7(0) _D2(7) LO2 _D3(0)
                    HI2 _D1 QLO4 DITHER5 _D2(5) LO2 _D3(0)
                        HI2 _D1 QLO4 SCALE4(0) _D2(4) LO2 _D3(0)
                            HI2 _D1 QLO4 ADJDITHER7(0) _D2(7) LO2 _D3(0)
        ...
        // If more than 45 uSecs have elapsed, give up on this frame and start
        // over. Note: this isn't completely correct. It's possible that more
        // than one millisecond will elapse, and so SysTick->VAL will lap
        ...
        if (ticksBeforeInterrupts < currentTicks) {
            // Timer started over
            if ((ticksBeforeInterrupts + (kTicksPerMs - currentTicks)) >
                kTicksIn45us) {
                return 0;
            }
        } else {
    ...
    asm __volatile__(
        ...
        LOADLEDS3(0) LOADDITHER7(0) DITHER5 SCALE4(0) ADJDITHER7(0) SWAPBBN1
            ...
            LOOP
                // Write out byte 0, prepping byte 1
                HI2 _D1 QLO4 NOTHING _D2(0) LO2 _D3(0) HI2 _D1 QLO4 LOADLEDS3(1)
                    _D2(3) LO2 _D3(0) HI2 _D1 QLO4 LOADDITHER7(1) _D2(7)
                        LO2 _D3(0) HI2 _D1 QLO4 DITHER5 _D2(5) LO2 _D3(0)
                            HI2 _D1 QLO4 SCALE4(1) _D2(4) LO2 _D3(0)
                                HI2 _D1 QLO4 ADJDITHER7(1) _D2(7) LO2 _D3(0)
                                    HI2 _D1 QLO4 NOTHING _D2(0) LO2 _D3(0)
                                        HI2 _D1 QLO4 SWAPBBN1 _D2(1) LO2 _D3(0)
        ...
        // Write out byte 1, prepping byte 2
        HI2 _D1 QLO4 NOTHING _D2(0) LO2 _D3(0) HI2 _D1 QLO4 LOADLEDS3(2) _D2(3)
            LO2 _D3(0) HI2 _D1 QLO4 LOADDITHER7(2) _D2(7) LO2 _D3(0)
                HI2 _D1 QLO4 DITHER5 _D2(5) LO2 _D3(0) HI2 _D1 QLO4 SCALE4(2)
                    _D2(4) LO2 _D3(0) HI2 _D1 QLO4 ADJDITHER7(2) _D2(7)
                        LO2 _D3(0) HI2 _D1 QLO4 INCLEDS3 _D2(3) LO2 _D3(0)
                            HI2 _D1 QLO4 SWAPBBN1 _D2(1) LO2 _D3(0)

        // Write out byte 2, prepping byte 0
        HI2 _D1 QLO4 NOTHING _D2(0) LO2 _D3(0) HI2 _D1 QLO4 LOADLEDS3(0) _D2(3)
            LO2 _D3(0) HI2 _D1 QLO4 LOADDITHER7(0) _D2(7) LO2 _D3(0)
                HI2 _D1 QLO4 DITHER5 _D2(5) LO2 _D3(0) HI2 _D1 QLO4 SCALE4(0)
                    _D2(4) LO2 _D3(0) HI2 _D1 QLO4 ADJDITHER7(0) _D2(7)
                        LO2 _D3(0) HI2 _D1 QLO4 NOTHING _D2(0) LO2 _D3(0)
