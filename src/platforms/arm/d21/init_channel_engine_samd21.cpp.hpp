...
///
/// This file provides lazy initialization of SAMD21-specific channel engines
...
static void addSpiHardwareIfPossible(ChannelBusManager& manager) {
    FL_DBG("SAMD21: Registering unified HW SPI channel engine");
...
void initChannelEngines() {
    FL_DBG("SAMD21: Lazy initialization of channel engines");
