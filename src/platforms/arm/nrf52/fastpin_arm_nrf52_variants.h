...
#warning                                                                       \
    "Adafruit Bluefruit nRF52832 Feather is an untested board -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
...
// _DEFPIN_ARM_IDENTITY_P0(22); // Factory Reset -- not vaild to use for
// FastLED? _DEFPIN_ARM_IDENTITY_P0(23); // N/A _DEFPIN_ARM_IDENTITY_P0(24); //
// N/A
...
#if !defined(FASTLED_NRF52_SUPPRESS_UNTESTED_BOARD_WARNING)
#warning                                                                       \
    "Adafruit Bluefruit nRF52840 Metro Express is an untested board -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
_FL_DEFPIN(0, 25, 0);  // D0  is P0.25 (UART TX)
_FL_DEFPIN(1, 24, 0);  // D1  is P0.24 (UART RX)
...
#error                                                                         \
    "Define of `USE_ARDUINO_PIN_NUMBERING` has known errors in pin mapping -- select different mapping"
...
// (it also has D60..D69 for A6..A15, which have no corresponding header on
// PCA10056) AREF has no equivalent digital pin map on Arduino, would be P0.02
...
#if !defined(FASTLED_NRF52_SUPPRESS_UNTESTED_BOARD_WARNING)
#warning                                                                       \
    "Adafruit ItsyBitsy nRF52840 Express is an untested board -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
...
// See
// https://github.com/sandeepmistry/arduino-nRF5/blob/master/variants/bluey/variant.cpp
...
#if !defined(FASTLED_NRF52_SUPPRESS_UNTESTED_BOARD_WARNING)
#warning                                                                       \
    "Electronut labs bluey is an untested board -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
...
// See
// https://github.com/sandeepmistry/arduino-nRF5/blob/master/variants/hackaBLE/variant.cpp
...
#if !defined(FASTLED_NRF52_SUPPRESS_UNTESTED_BOARD_WARNING)
#warning                                                                       \
    "Electronut labs hackaBLE is an untested board -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
...
// See
// https://github.com/sandeepmistry/arduino-nRF5/blob/master/variants/hackaBLE_v2/variant.cpp
...
#if !defined(FASTLED_NRF52_SUPPRESS_UNTESTED_BOARD_WARNING)
#warning                                                                       \
    "Electronut labs hackaBLE_v2 is an untested board -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
...
// RedBear Blend 2
// See
// https://github.com/sandeepmistry/arduino-nRF5/blob/master/variants/RedBear_Blend2/variant.cpp
...
#if !defined(FASTLED_NRF52_SUPPRESS_UNTESTED_BOARD_WARNING)
#warning                                                                       \
    "RedBear Blend 2 is an untested board -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
...
// RedBear BLE Nano 2
// See
// https://github.com/sandeepmistry/arduino-nRF5/blob/master/variants/RedBear_BLENano2/variant.cpp
...
#if !defined(FASTLED_NRF52_SUPPRESS_UNTESTED_BOARD_WARNING)
#warning                                                                       \
    "RedBear BLE Nano 2 is an untested board -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
...
// See
// https://github.com/sandeepmistry/arduino-nRF5/blob/master/variants/nRF52DK/variant.cpp
...
#if !defined(FASTLED_NRF52_SUPPRESS_UNTESTED_BOARD_WARNING)
#warning                                                                       \
    "Nordic Semiconductor nRF52 DK is an untested board -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
_FL_DEFPIN(0, 11, 0);  // D0  is P0.11
_FL_DEFPIN(1, 12, 0);  // D1  is P0.12
...
#if !defined(FASTLED_NRF52_SUPPRESS_UNTESTED_BOARD_WARNING)
#warning                                                                       \
    "Taida Century nRF52 mini board is an untested board -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
...
#if !defined(FASTLED_NRF52_SUPPRESS_UNTESTED_BOARD_WARNING)
#warning                                                                       \
    "Using `generic` NRF52832 board is an untested configuration -- test and let use know your results via https://github.com/FastLED/FastLED/issues"
#endif
