...
/// @file platforms/arm/renesas/ldf_headers.h
/// Renesas PlatformIO Library Dependency Finder (LDF) hints
///
...
// Renesas platform - no additional LDF hints needed currently
