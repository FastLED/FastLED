...
// Teensy 3.x family umbrella (all 3.x boards)
    ...
    #define FL_IS_TEENSY_3X 1
#endif

// Teensy 4.x family umbrella (all 4.x boards)
#if defined(FL_IS_TEENSY_40) || defined(FL_IS_TEENSY_41)
    #define FL_IS_TEENSY_4X 1
#endif

// General Teensy platform (any Teensy board)
#if defined(FL_IS_TEENSY_LC) || defined(FL_IS_TEENSY_3X) || defined(FL_IS_TEENSY_4X)
    #define FL_IS_TEENSY 1
#endif

// Provide undefined defaults for all macros (for consistent checking)
#ifndef FL_IS_TEENSY
    #define FL_IS_TEENSY 0
#endif

#ifndef FL_IS_TEENSY_LC
    #define FL_IS_TEENSY_LC 0
#endif

#ifndef FL_IS_TEENSY_30
    #define FL_IS_TEENSY_30 0
#endif

#ifndef FL_IS_TEENSY_31
    #define FL_IS_TEENSY_31 0
#endif

#ifndef FL_IS_TEENSY_32
    #define FL_IS_TEENSY_32 0
#endif

#ifndef FL_IS_TEENSY_35
    #define FL_IS_TEENSY_35 0
#endif

#ifndef FL_IS_TEENSY_36
    #define FL_IS_TEENSY_36 0
#endif

#ifndef FL_IS_TEENSY_3X
    #define FL_IS_TEENSY_3X 0
#endif

#ifndef FL_IS_TEENSY_40
    #define FL_IS_TEENSY_40 0
#endif

#ifndef FL_IS_TEENSY_41
    #define FL_IS_TEENSY_41 0
#endif

#ifndef FL_IS_TEENSY_4X
    #define FL_IS_TEENSY_4X 0
#endif
