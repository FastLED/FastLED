...
class SPIOutput<SPI_DATA, SPI_CLOCK, _SPI_SPEED> : public SPIDeviceProxy<SPI_DATA, SPI_CLOCK, _SPI_SPEED, SPI, 0> {};

/// Specialization for secondary SPI peripheral (SPI1 object)
template<u32 _SPI_SPEED>
class SPIOutput<SPI1_DATA, SPI1_CLOCK, _SPI_SPEED> : public SPIDeviceProxy<SPI1_DATA, SPI1_CLOCK, _SPI_SPEED, SPI1, 1> {};

/// Specialization for tertiary SPI peripheral (SPI2 object)
template<u32 _SPI_SPEED>
class SPIOutput<SPI2_DATA, SPI2_CLOCK, _SPI_SPEED> : public SPIDeviceProxy<SPI2_DATA, SPI2_CLOCK, _SPI_SPEED, SPI2, 2> {};
