...
///
/// Defines one of:
/// - FL_STM32_CORE_STMDUINO: Official STMicroelectronics Arduino core (modern)
/// - FL_STM32_CORE_LIBMAPLE: Roger Clark Arduino_STM32 core (legacy, deprecated)
/// - FL_STM32_CORE_PARTICLE: Particle firmware (Photon/Electron)
/// - FL_STM32_CORE_UNKNOWN: Unknown/unsupported core
///
...
// Source: https://github.com/stm32duino/Arduino_Core_STM32/issues/946
  ...
  // STM32_CORE_VERSION available since v1.5.0 (format: 0xAABBCCPP = AA.BB.CC.PP)
  #ifdef STM32_CORE_VERSION
    #define FL_STM32_CORE_VERSION STM32_CORE_VERSION
  #else
    #define FL_STM32_CORE_VERSION 0x00000000  // Unknown version (pre-1.5.0)
  #endif
...
#if defined(FL_STM32_CORE_STMDUINO)
...
#if defined(FL_STM32_CORE_STMDUINO) || defined(FL_STM32_CORE_PARTICLE)
