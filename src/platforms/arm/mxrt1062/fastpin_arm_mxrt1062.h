...
template<u8 PIN, u32 _BIT, u32 _MASK, typename _GPIO_DR, typename _GPIO_DR_SET, typename _GPIO_DR_CLEAR, typename _GPIO_DR_TOGGLE> class _ARMPIN : public ValidPinBase {
public:
...
// Teensy 4.0: pins 0-39
// Teensy 4.1: pins 0-54
...
// Teensy 4.1 additional pins (40-54)
#if defined(ARDUINO_TEENSY41)
_FL_DEFPIN(40,20,6); _FL_DEFPIN(41,21,6); _FL_DEFPIN(42,15,8); _FL_DEFPIN(43,14,8);
_FL_DEFPIN(44,13,8); _FL_DEFPIN(45,12,8); _FL_DEFPIN(46,17,8); _FL_DEFPIN(47,16,8);
_FL_DEFPIN(48,24,9); _FL_DEFPIN(49,27,9); _FL_DEFPIN(50,28,9); _FL_DEFPIN(51,22,9);
_FL_DEFPIN(52,26,9); _FL_DEFPIN(53,25,9); _FL_DEFPIN(54,29,9);
#endif
