...
/// Template definition for teensy LC style ARM pins, providing direct access to
/// the various GPIO registers.  Note that this uses the full port GPIO
...
#define _FL_IO(L, C)                                                           \
    ...
    _RD32(FGPIO##L##_PDIR);                                                    \
    _RD32(FGPIO##L##_PDDR);                                                    \
    _FL_DEFINE_PORT3(L, C, _R(FGPIO##L##_PDOR));

#define _FL_DEFPIN(PIN, BIT, L)                                                \
    template <>                                                                \
    class FastPin<PIN>                                                         \
        : public _ARMPIN<PIN, 1 << BIT, _R(FGPIO##L##_PDOR),                   \
                         _R(FGPIO##L##_PSOR), _R(FGPIO##L##_PCOR),             \
