/// @file JsonExample.ino
/// @brief Demonstrates the improved JSON API with FastLED
///
...
#include "FastLED.h"
#include "fl/json.h" // Using the improved JSON API
...
void setup() {
    ...
    if (!json.is_null()) {
        ...
        // Check if keys exist
        if (json.contains("strip")) {
            Serial.println("Found 'strip' configuration");
        }
