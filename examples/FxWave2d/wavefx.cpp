...
WaveFx::Args CreateArgsLower() {
    ...
    out.crgbMap = fl::make_intrusive<WaveCrgbGradientMap>(electricBlueFirePal);  // Color palette for this wave
    return out;
}
...
WaveFx::Args CreateArgsUpper() {
    ...
    out.crgbMap = fl::make_intrusive<WaveCrgbGradientMap>(electricGreenFirePal);  // Color palette for this wave
    return out;
}
