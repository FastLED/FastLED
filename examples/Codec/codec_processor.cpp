...
void processGif() {
    ...
    memcpy(gifData.data(), CodecData::sampleGifData, CodecData::sampleGifDataLength);
...
void processMpeg1() {
    ...
    memcpy(mpegData.data(), CodecData::sampleMpeg1Data, CodecData::sampleMpeg1DataLength);
