...
// RX infrastructure
fl::esp32::RmtRxChannel rx_channel(static_cast<gpio_num_t>(RMT_RX_PIN), 40000000);
...
rmt_symbol_word_t rx_symbols[1024];
...
void setup() {
    ...
    if (!rx_channel.begin()) {
        ...
        Serial.println("Check wiring and GPIO pin availability");
        while (1) { delay(1000); }
    }
