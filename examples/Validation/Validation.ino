...
fl::shared_ptr<fl::esp32::RmtRxDecoder> rx_decoder;  // Decoder instance (initialized in setup)
...
void setup() {
    ...
    // Initialize RX decoder using factory method
    rx_decoder = fl::esp32::RmtRxDecoder::create(fl::esp32::CHIPSET_TIMING_WS2812B_RX, 40000000);
    if (!rx_decoder) {
        Serial.println("FATAL: RX decoder init failed");
        while (1) { delay(1000); }
    }
