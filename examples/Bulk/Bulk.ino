...
// Controllers
BulkClockless<WS2812_CHIPSET, RMT>* rmt_bulk = nullptr;
BulkClockless<WS2812_CHIPSET, LCD_I80>* lcd_bulk = nullptr;
...
void setup() {
    ...
    auto& lcd_ref = FastLED.addBulkLeds<WS2812_CHIPSET, LCD_I80>({
    ...
    auto& rmt_ref = FastLED.addBulkLeds<WS2812_CHIPSET, RMT>({
