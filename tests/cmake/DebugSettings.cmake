    ...
    elseif(level STREQUAL "FULL")
        ...
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
            ...
            if(WIN32)
                ...
                message(STATUS "Debug symbols: FULL (DWARF + CodeView for Clang on Windows)")
            else()
                # Non-Windows: standard DWARF debug info
                message(STATUS "Debug symbols: FULL (DWARF format for Clang)")
            endif()
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
