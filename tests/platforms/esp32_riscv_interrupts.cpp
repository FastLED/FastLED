...
TEST_CASE("riscv_interrupt_constants") {
    ...
    FL_CHECK(FASTLED_RISCV_MAX_EXT_INTERRUPTS == 31);
    #elif defined(CONFIG_IDF_TARGET_ESP32C6)
    FL_CHECK(FASTLED_RISCV_MAX_EXT_INTERRUPTS == 28);
    #endif

    FL_CHECK(FASTLED_RISCV_MAX_PRIORITY == 7);
    FL_CHECK(FASTLED_RISCV_PRIORITY_OFFICIAL_MAX == 3);
    FL_CHECK(FASTLED_RISCV_PRIORITY_RECOMMENDED == 3);
    FL_CHECK(FASTLED_RISCV_PRIORITY_MEDIUM == 2);
...
TEST_CASE("riscv_handler_functions_exist") {
    ...
    FL_CHECK(official_handler != nullptr);
    FL_CHECK(experimental_handler != nullptr);
    FL_CHECK(rmt_official_handler != nullptr);
...
TEST_CASE("riscv_interrupt_trampoline_macro") {
    ...
    FL_CHECK(trampoline_ptr != nullptr);
