...
// =======================
// This test suite provides comprehensive coverage of StrStream and FakeStrStream
...
// 7. FakeStrStream compatibility with all types
...
TEST_CASE("StrStream comprehensive fl:: integer types") {
    SUBCASE("fl::i8") {
        ...
        fl::i8 val = -10;
        s << val;
        // fl::i8 is signed char, which displays as a number due to StrStream's handling
        CHECK(s.str().size() > 0);
    }
...
TEST_CASE("StrStream comprehensive fundamental integer types") {
    ...
    SUBCASE("signed char") {
        ...
        signed char val = -10;
        s << val;
        // signed char may display as character or number depending on StrStream implementation
        CHECK(s.str().size() > 0);
    }
