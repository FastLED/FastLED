...
TEST_CASE("fl::fastled_file_offset") {
    SUBCASE("extracts path after 'src/'") {
        ...
        FL_CHECK_EQ(fl::strcmp(fastled_file_offset(path2), "src/fl/math.h"), 0);
    ...
    SUBCASE("falls back to last slash when no 'src/' found") {
        ...
        FL_CHECK_EQ(fl::strcmp(fastled_file_offset(path2), "file.cpp"), 0);
    ...
    SUBCASE("handles edge cases") {
        ...
        FL_CHECK_EQ(fl::strcmp(fastled_file_offset(single_slash), ""), 0);

        // Path ending with slash
        const char* ending_slash = "path/to/dir/";
        FL_CHECK_EQ(fl::strcmp(fastled_file_offset(ending_slash), ""), 0);
    ...
    SUBCASE("handles paths with 'src' but not 'src/'") {
        ...
        FL_CHECK_EQ(fl::strcmp(fastled_file_offset(path2), "code.cpp"), 0);
    }
}
