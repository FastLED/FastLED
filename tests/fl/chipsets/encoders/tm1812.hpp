...
FL_TEST_CASE("TM1812 RGBWW - timing trait selects the packing encoder") {
    FL_CHECK_EQ(TIMING_TM1812_RGBWW_800KHZ::T1, 400u);
    FL_CHECK_EQ(TIMING_TM1812_RGBWW_800KHZ::T2, 450u);
    FL_CHECK_EQ(TIMING_TM1812_RGBWW_800KHZ::T3, 400u);
    FL_CHECK_EQ(TIMING_TM1812_RGBWW_800KHZ::RESET, 24u);
