// Debug tool to trace SIMD Perlin noise intermediate values// Compile: clang-tool-chain-clang++ -std=c++17 -I../../src -msse2 -o debug_perlin_simd.exe tests/profile/debug_perlin_simd.cpp
...
int main() {
    ...
    // Test coordinates that triggered the bug
    fl::i32 nx = 3155921;
    fl::i32 ny = 3313496;

    printf("=== Perlin s16x16 Debug Test ===\n");
    printf("Testing nx=%d, ny=%d\n\n", nx, ny);

    // Scalar evaluation with debug output
    printf("--- SCALAR ---\n");
