...
|---------|---------|------------|-----------|------------|-----------|---------|
| [![fastled-compiler-avr](https://img.shields.io/docker/v/niteris/fastled-compiler-avr/latest?label=avr)](https://hub.docker.com/r/niteris/fastled-compiler-avr) | [![fastled-compiler-esp-32s3](https://img.shields.io/docker/v/niteris/fastled-compiler-esp-32s3/latest?label=esp)](https://hub.docker.com/r/niteris/fastled-compiler-esp-32s3) | [![fastled-compiler-teensy](https://img.shields.io/docker/v/niteris/fastled-compiler-teensy/latest?label=teensy)](https://hub.docker.com/r/niteris/fastled-compiler-teensy) | [![fastled-compiler-stm32](https://img.shields.io/docker/v/niteris/fastled-compiler-stm32/latest?label=stm32)](https://hub.docker.com/r/niteris/fastled-compiler-stm32) | [![fastled-compiler-rp](https://img.shields.io/docker/v/niteris/fastled-compiler-rp/latest?label=rp2040)](https://hub.docker.com/r/niteris/fastled-compiler-rp) | [![fastled-compiler-nrf52](https://img.shields.io/docker/v/niteris/fastled-compiler-nrf52/latest?label=nrf52)](https://hub.docker.com/r/niteris/fastled-compiler-nrf52) | [![fastled-compiler-sam](https://img.shields.io/docker/v/niteris/fastled-compiler-sam/latest?label=sam)](https://hub.docker.com/r/niteris/fastled-compiler-sam) |

Most Docker images contain pre-cached toolchains for all boards in their platform family (AVR, Teensy, etc.), while ESP boards use individual images per chip to prevent build artifact accumulation. All images enable fast compilation without downloading dependencies for every build.
